...
//
//
//        StringBuilder(inhoud).reverse().toString()
//        geefAllePermutatiesVanDrieMetStringBuilder -> H14oef5
//        matches éà -> H14oef8
//        matches  e-mail, postcode, huisnummer
...
//                        lvAannemers.setItems(items); // items -> String[]
//
